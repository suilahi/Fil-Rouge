    ...
    public class AuthService {
        ...
        public AuthResponseDTO register(RegisterDto registerDTO) {
            ...
            // Choisir la sous-classe selon le rôle
            switch (role) {
                case "ENTRAINEUR" -> utilisateur = new Entraineur();
                case "MEMBRE" -> utilisateur = new Membre();
                default -> utilisateur = new User(); // ou autre rôle générique
            }
